window.addEventListener('load', function() {
    ...
    const btnAcelerarValor = document.querySelector("#acelerar span");
    ...
    btnAcelerar.addEventListener("click", function(e) {
        acelerar();
        if (btnPausa.addEventListener == "ckick") {
            pausar();
        } else if (btnStop.addEventListener == "ckick") {
            reiniciar();
        }
    });
    ...
    function acelerar() {
        ...
        btnAcelerarValor.innerHTML = btnAcelerarValor.innerHTML * 2;
    };
});